...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--convert_mode", choices=["parsed", "brief"], default="parsed", help="변환 모드 (기본: parsed)")
    return p
...
def main(argv: list[str] | None = None) -> None:
    ...
    source_file = "parsed_analysis.json" if args.convert_mode == "parsed" else "brief_analysis.json"
    ...
    process_fn = _process_parsed if args.convert_mode == "parsed" else _process_brief
    print(f"변환 대상: {len(targets)}개  (mode={args.convert_mode})")
