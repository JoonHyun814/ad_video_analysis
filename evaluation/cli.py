...
_MODES: dict[str, tuple[str, str]] = {
    ...
    "concept": ("evaluation.concept.run", "컨셉 추출 + ad_concept_reference 벡터 적재(--load_facets 는 레거시 facet 적재)"),
    ...
    "ad_concept_production": ("evaluation.ad_concept_production.run",
                              "scenario_analysis → concept+production 추출 + 두 컬렉션 적재(통합)"),
