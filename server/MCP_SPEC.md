# chromadb-explorer-network — MCP 연동 명세서

내부망의 **다른 서버/프로젝트**가 이 저장소의 광고 분석 검색 기능을 MCP로 호출하기 위한
명세서다. 빌드·배포·운영 방법은 [`README.md`](README.md)를 참고하고, 이 문서는 **연결 정보와
도구 스펙**만 다룬다.
